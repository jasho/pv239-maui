...
namespace PV239_06_API.Core.Api
{
    ...
    public partial class ApiClient : ServiceClient<ApiClient>, IApiClient, IAzureClient
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> TodoInsertOrUpdateItemWithHttpMessagesAsync(TodoItemDtoInner body = default(TodoItemDtoInner), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "TodoInsertOrUpdateItem", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
